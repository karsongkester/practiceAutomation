...
module.exports = {
    ...
    'Selectors': browser => {
        var searchBar = '.enter-location_input'
        var submitButton = '.enter-location_submit'
        var resultingCity = '.current-weather_location'
        browser
    ...
    'Test data': browser => {
        var newEmployeeName = 'Drake Yo'
        var newEmployeePhone = '8013453789'
        var newEmployeeTitle = 'President'
        browser
